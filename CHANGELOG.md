...
## [3.44.0-beta.0](https://github.com/PiR1/picpeak/compare/v3.43.3-beta.0...v3.44.0-beta.0) (2026-05-10)


### Features

* add admin dark mode and SEO/robots.txt settings ([9c2a0d2](https://github.com/PiR1/picpeak/commit/9c2a0d272a21dfcace2ec795034e2f1adcba47e0))
* add bulk category editing for photos ([#157](https://github.com/PiR1/picpeak/issues/157)) ([eca36c7](https://github.com/PiR1/picpeak/commit/eca36c70a23f18f937a9f5bddeff855e18f364c3))
* add category hero/cover photo selection ([#163](https://github.com/PiR1/picpeak/issues/163)) ([6c30e2c](https://github.com/PiR1/picpeak/commit/6c30e2c2edd19a24d4f30a9558690bb7e2331b32))
* add configurable upload batch size for reverse proxy compatibility ([#208](https://github.com/PiR1/picpeak/issues/208)) ([02a46e0](https://github.com/PiR1/picpeak/commit/02a46e083d68cfdb355b5a4fe4a8da7d667050b9))
* add COOKIE_SECURE=auto for mixed HTTPS/HTTP deployments ([#298](https://github.com/PiR1/picpeak/issues/298)) ([b1dfbe4](https://github.com/PiR1/picpeak/commit/b1dfbe4c2fe271d8087974d02cf724f04058bdc9))
* add COOKIE_SECURE=auto for mixed HTTPS/HTTP deployments ([#298](https://github.com/PiR1/picpeak/issues/298)) ([15a8ab4](https://github.com/PiR1/picpeak/commit/15a8ab41fd1c94e3397d300b161cd1fdd459ea05))
* add customizable event types with admin management ([f8881d5](https://github.com/PiR1/picpeak/commit/f8881d5bd62d449fb40917ec8c20f0eb16c1fdad))
* add Dutch (nl) locale and fix missing translation keys across all locales ([b54a80d](https://github.com/PiR1/picpeak/commit/b54a80d251bcbb9a126e32eeaef522688bc810c6))
* add Dutch locale and fix missing translation keys ([e32da68](https://github.com/PiR1/picpeak/commit/e32da68cbdfa430d62cbb1057ea418dc6b2f14fb))
* add Gallery Premium and Gallery Story layouts (Beta) ([e179def](https://github.com/PiR1/picpeak/commit/e179def3cceefe5fd6acd5574f2986e4f9e223ef))
* add hero image focal point picker with anchor positioning ([#162](https://github.com/PiR1/picpeak/issues/162)) ([734868a](https://github.com/PiR1/picpeak/commit/734868abc23731b0ac9ad73e799194df1e6aa6ab))
* add justified layout modes and aspect-ratio-aware mosaic ([#146](https://github.com/PiR1/picpeak/issues/146)) ([608bbd5](https://github.com/PiR1/picpeak/commit/608bbd50e7b31d49c7516a00e96f284fa16e2777))
* Add justified layout modes and aspect-ratio-aware mosaic ([#146](https://github.com/PiR1/picpeak/issues/146)) ([ef2ae00](https://github.com/PiR1/picpeak/commit/ef2ae00ff20b754c2f2ed797e18c146d12d7f31a))
* add justified/rows layout mode to masonry gallery ([#146](https://github.com/PiR1/picpeak/issues/146)) ([e081b56](https://github.com/PiR1/picpeak/commit/e081b56a44bf9fdaa3dd225d5dd4dde35bfe83d3))
* add justified/rows layout mode to masonry gallery ([#146](https://github.com/PiR1/picpeak/issues/146)) + security fixes ([cd1d504](https://github.com/PiR1/picpeak/commit/cd1d50474f673b759c2f9401fdbe209a84773e39))
* add original filename preservation and Lightroom export support ([a59f414](https://github.com/PiR1/picpeak/commit/a59f41463f960a3a74ce3933dc7db84ee3a2018d))
* add original filename preservation and Lightroom export support ([9872ad3](https://github.com/PiR1/picpeak/commit/9872ad3aef6488b359c5499a6dc3d8bfbfa48fde))
* add per-event custom logo upload with bug fixes ([85170b8](https://github.com/PiR1/picpeak/commit/85170b883f504d83f1d862abb3f4e46741074826))
* add per-event hero logo customization options ([0790a1d](https://github.com/PiR1/picpeak/commit/0790a1ddad774af89827a0a392e9fae0a945bff2))
* add per-gallery thumbnail scale setting ([#172](https://github.com/PiR1/picpeak/issues/172)) ([#251](https://github.com/PiR1/picpeak/issues/251)) ([ee46088](https://github.com/PiR1/picpeak/commit/ee46088985ebbbb81d16e5bac23be2060c94397f))
* add photo cap per event and Portuguese (pt-BR) locale ([1fa222e](https://github.com/PiR1/picpeak/commit/1fa222e9c4c26e525c7899e368988c6b0b08da85))
* add photo cap per event and Portuguese locale ([088de43](https://github.com/PiR1/picpeak/commit/088de43f09f974d444f50452ef1117315c289ebc))
* add quilted layout, fix mosaic, and backfill photo dimensions ([#146](https://github.com/PiR1/picpeak/issues/146)) ([46ed1bc](https://github.com/PiR1/picpeak/commit/46ed1bc276867a25b27bf22cd9b9d7e879a6947b))
* add thumbnail settings UI to admin panel ([3a30fea](https://github.com/PiR1/picpeak/commit/3a30fea862034d64fbc7188fc25292594a9319e2))
* add thumbnail settings UI to admin settings page ([#206](https://github.com/PiR1/picpeak/issues/206)) ([7d6d2f5](https://github.com/PiR1/picpeak/commit/7d6d2f56883a4402f0d97c95b0432a8a783c8024))
* add update instructions dialog, email notifications, and capture date sorting ([50c0990](https://github.com/PiR1/picpeak/commit/50c09904a9434f988ab32a07da5d24db0e02065e)), closes [#181](https://github.com/PiR1/picpeak/issues/181)
* add visual WYSIWYG email template editor ([#229](https://github.com/PiR1/picpeak/issues/229)) ([04a7ea8](https://github.com/PiR1/picpeak/commit/04a7ea80f95d6aeb474b145292e75f45fb85c66d))
* **branding:** 8-token CI palette + force color mode + dark-mode consistency ([8050927](https://github.com/PiR1/picpeak/commit/80509276074b8125b6d676839afabb0b6f89206f))
* **branding:** force color mode (dark or light) site-wide ([5a162fc](https://github.com/PiR1/picpeak/commit/5a162fc8bec47a49cb1bcaa92ff72e197e8d2e42))
* **branding:** inline force color mode with auto-save + clearer palette help text ([67d7d8d](https://github.com/PiR1/picpeak/commit/67d7d8d3fa25ceab0eda02b291f2e220b222f84a))
* **branding:** per-family generic fallback via meta.json ([dcff451](https://github.com/PiR1/picpeak/commit/dcff4515721482e06c2ef1c1eb34f9e12754c07c))
* **branding:** preview each font in its own face in the picker dropdown ([b4f9b65](https://github.com/PiR1/picpeak/commit/b4f9b65f1df4c400f22b28f20e1304ec57279d33))
* **branding:** self-hosted webfonts with filesystem scanner ([d04bf28](https://github.com/PiR1/picpeak/commit/d04bf288084144bf53ef0ba988fa32ed703d7351))
* **branding:** self-hosted webfonts with filesystem scanner ([bac51fe](https://github.com/PiR1/picpeak/commit/bac51fe69a39f85381f445e8da6cd63cf5826fc4))
* **cms:** add external URL toggle for imprint and privacy pages ([b2c8161](https://github.com/PiR1/picpeak/commit/b2c8161a43c2d0b09d6783e791b3f26862254824))
* **cms:** add per-page external URL override — backend ([66423bb](https://github.com/PiR1/picpeak/commit/66423bb65e83b6204509c9a98d783ba8255c3364))
* **cms:** admin UI for external imprint/privacy URL ([a4e3d10](https://github.com/PiR1/picpeak/commit/a4e3d10fb0c97ea07c4b08d16c0947945d8a7576))
* **cms:** redirect legal links to external URL when configured ([c5bba50](https://github.com/PiR1/picpeak/commit/c5bba505ac92b5257f6bb1c069b8bc23ea6a5a1b))
* configurable upload batch size for reverse proxy compatibility ([9b7495e](https://github.com/PiR1/picpeak/commit/9b7495e0054975e66c9b5006c24a9fae63969de4))
* configurable upload batch size for reverse proxy compatibility ([4243363](https://github.com/PiR1/picpeak/commit/424336340bef8e1629490ade154f0ceebb2a71e1))
* customisable 404 + gallery-not-found pages via CMS ([#324](https://github.com/PiR1/picpeak/issues/324)) ([4f77905](https://github.com/PiR1/picpeak/commit/4f77905b87bea474b3d2496350996deaad041230))
* decouple hero header from gallery layouts ([#158](https://github.com/PiR1/picpeak/issues/158)) ([7b8d8bd](https://github.com/PiR1/picpeak/commit/7b8d8bd92ba7a96717bb4d821b38dddc395f701a))
* draft mode, admin branding, and workflow improvements ([dc98206](https://github.com/PiR1/picpeak/commit/dc98206737d1ebe43637319ce8c5b6da2e44c05d))
* draft mode, admin branding, and workflow improvements ([40332a7](https://github.com/PiR1/picpeak/commit/40332a71db6534097940d3f9362b0fe651dba6c7))
* **email:** expand email palette to 8 tokens + Sync from Branding button ([47b6b39](https://github.com/PiR1/picpeak/commit/47b6b39f3a942aee93b970031d95a952cb769d09))
* **events:** add Photos column to admin events list ([#384](https://github.com/PiR1/picpeak/issues/384)) ([d561db8](https://github.com/PiR1/picpeak/commit/d561db802b04db8fbb38819a22e840532e775ef0))
* **events:** add Photos column to admin events list ([#384](https://github.com/PiR1/picpeak/issues/384)) ([ffb4318](https://github.com/PiR1/picpeak/commit/ffb4318a1f667e273cd59805673b125d2f17699b))
* **events:** bulk delete with password confirmation ([#384](https://github.com/PiR1/picpeak/issues/384)) ([647aea2](https://github.com/PiR1/picpeak/commit/647aea21ae42fe0d089bf45568702617a25b98e4))
* **events:** bulk delete with password confirmation ([#384](https://github.com/PiR1/picpeak/issues/384)) ([48d538f](https://github.com/PiR1/picpeak/commit/48d538f94fd39d9b85ec57c57301a8490b7d4f6d))
* **events:** prefill admin email + admin picker on event creation ([3fe8e61](https://github.com/PiR1/picpeak/commit/3fe8e61bd1175e35dcb61604447e5d9c2e902ec5))
* **events:** prefill admin email + admin picker on event creation ([ee56b67](https://github.com/PiR1/picpeak/commit/ee56b6762f5b2eb9ea42f4abe4dde4356e2e54e6))
* **events:** Sync from Branding button in gallery theme customizer + clarified default inheritance ([bdbe7b8](https://github.com/PiR1/picpeak/commit/bdbe7b80a13b8b215ac544ba9105100e792eeda2))
* **events:** tree view for external media folder picker ([cdd40ac](https://github.com/PiR1/picpeak/commit/cdd40acb4591d4eb8f80a79c69201556eab1bfd0))
* **events:** tree view for external media folder picker ([f927b09](https://github.com/PiR1/picpeak/commit/f927b09c70f3b6a5c81c3726609a29680b96b6fc))
* **frontend:** dedupe /public/settings via shared usePublicSettings hook ([#325](https://github.com/PiR1/picpeak/issues/325)) ([3d4ae4d](https://github.com/PiR1/picpeak/commit/3d4ae4d7e9f9995d93563e8092e05215362afb3b))
* gallery layouts, bulk category editing, and hero header improvements ([7037106](https://github.com/PiR1/picpeak/commit/7037106bff62593bba600d898a781f79f07b459d))
* gallery layouts, hero customization, bulk categories & event types ([d9e00dc](https://github.com/PiR1/picpeak/commit/d9e00dc0dbd7cef0ddb4665e5306c98aac3573e3))
* gallery layouts, hero customization, event types, and UX improvements ([#146](https://github.com/PiR1/picpeak/issues/146), [#155](https://github.com/PiR1/picpeak/issues/155)-163, [#170](https://github.com/PiR1/picpeak/issues/170), [#171](https://github.com/PiR1/picpeak/issues/171)) ([4280444](https://github.com/PiR1/picpeak/commit/4280444d70e73db09e67e18ce25bac75cf499b75))
* **gallery:** decouple header style from layout, add banner option ([1f1a856](https://github.com/PiR1/picpeak/commit/1f1a856083b1966ed4b32a23a14442f1727cecef))
* **gallery:** decouple header style from layout, add banner option ([24d7277](https://github.com/PiR1/picpeak/commit/24d727752c442263a6469e0aefa666454a4c652f))
* **gallery:** decouple header style from layout, add banner option ([aff29c9](https://github.com/PiR1/picpeak/commit/aff29c91bbb250debe74e2a512047ee40e157a34))
* **gallery:** icon-only menu, accent Download CTA ([#386](https://github.com/PiR1/picpeak/issues/386)) ([876b35b](https://github.com/PiR1/picpeak/commit/876b35b4a512f70cfc19561e35ce9d915a599547))
* **gallery:** icon-only menu, accent Download CTA, logo aligned ([#386](https://github.com/PiR1/picpeak/issues/386)) ([de8ad5f](https://github.com/PiR1/picpeak/commit/de8ad5fdd5ce1b9552ca8ca6e405d15c7372a4c8))
* guest selections with per-person identity ([#292](https://github.com/PiR1/picpeak/issues/292)) ([3856ba2](https://github.com/PiR1/picpeak/commit/3856ba25bbce971b07bba4dad19e7bdceca98cab))
* guest selections with per-person identity ([#292](https://github.com/PiR1/picpeak/issues/292)) ([ad4e5a7](https://github.com/PiR1/picpeak/commit/ad4e5a7506bc9217d1223101da0bc112047532a8))
* **i18n:** add Brazilian Portuguese (pt-BR) locale ([375f512](https://github.com/PiR1/picpeak/commit/375f51285b5db9c0dfcc04761d24927282e57796))
* **i18n:** improve pt locale with pt-BR phrasings, remove duplicate pt-BR file ([f25559c](https://github.com/PiR1/picpeak/commit/f25559c0e76776f7cfe8d187e1fea05e751bbafe))
* improve gallery layouts with aspect-ratio-aware masonry and mosaic modes ([#146](https://github.com/PiR1/picpeak/issues/146)) ([aacfcd5](https://github.com/PiR1/picpeak/commit/aacfcd517ea5739e834cf84627b55b3449740a5c))
* improve hero image UX and live preview ([#163](https://github.com/PiR1/picpeak/issues/163), [#158](https://github.com/PiR1/picpeak/issues/158)) ([d63f67a](https://github.com/PiR1/picpeak/commit/d63f67a2afba1b92610382aa1012428ccacb86bd))
* **localization:** add French translations for fit options in thumbnails ([2c12885](https://github.com/PiR1/picpeak/commit/2c1288583fe787c1514c3cace0e2d92a212bb3a3))
* **localization:** add i18next configuration and CLI commands for localization management ([74e87b9](https://github.com/PiR1/picpeak/commit/74e87b968b3152603dbfca72fae06372b7c7f519))
* **localization:** add i18next extraction helper & refactor backup configuration component to tsx ([e7228b0](https://github.com/PiR1/picpeak/commit/e7228b07805a40aa67ccb7e3592848218eabbca2))
* **localization:** add missing translations ([86ee6c8](https://github.com/PiR1/picpeak/commit/86ee6c80aa1f26b2ad47775337ebed301193e662))
* **localization:** improve English translations for clarity and consistency ([46b99c6](https://github.com/PiR1/picpeak/commit/46b99c629215832e66d9215a210fd6eaf8c89fb4))
* **localization:** update thumbnail settings and add fit options translations ([5fc427c](https://github.com/PiR1/picpeak/commit/5fc427c74b5cdda6ce1568006d9a94abdc692b3b))
* multilingual email templates with translations table ([8c5996e](https://github.com/PiR1/picpeak/commit/8c5996e4ec43b2817d84cc040cfe52878ffb61d5))
* multilingual email templates with translations table ([f50d7c0](https://github.com/PiR1/picpeak/commit/f50d7c0c51aa84a2182e450cd4b6a00777a8f9c0))
* native multi-arch Docker images (Apple Silicon, ARM64 Linux) ([df30618](https://github.com/PiR1/picpeak/commit/df3061893d154152b75b8ab0d07e0b1e0078431d))
* native S3 storage backend ([#328](https://github.com/PiR1/picpeak/issues/328)) + presigned download follow-up ([1b717ce](https://github.com/PiR1/picpeak/commit/1b717ce5ededa343d2fbb7e1c3493b4434743565))
* new features and bug fixes for beta release ([151e1bf](https://github.com/PiR1/picpeak/commit/151e1bf50f206ae0571fa044c75b8bc9f0f40120))
* optional customer phone field gated by global toggle ([#322](https://github.com/PiR1/picpeak/issues/322)) ([be6cb28](https://github.com/PiR1/picpeak/commit/be6cb28c8097d2277c1af2a32cf8bc88ebbc7136))
* original filename in admin UI, update dialog, and security hardening ([3ea9d5b](https://github.com/PiR1/picpeak/commit/3ea9d5b1219980032cbee7a2564c0004948923f5))
* original filename in admin UI, update dialog, security hardening, and bug fixes ([bcf2745](https://github.com/PiR1/picpeak/commit/bcf2745ab64acb968ae4bd0710b28e78c14f340c))
* outbound webhooks for event/photo lifecycle ([#327](https://github.com/PiR1/picpeak/issues/327)) ([c488f48](https://github.com/PiR1/picpeak/commit/c488f481caacf0d63dafc47f509e8de2708bc30f))
* per-event custom logos, customizable event types, and multiple bug fixes ([4c08160](https://github.com/PiR1/picpeak/commit/4c081601e02888d7ad289acb7847aee9d6f5703f))
* photo visibility control with client access ([#172](https://github.com/PiR1/picpeak/issues/172)) ([4a93e4e](https://github.com/PiR1/picpeak/commit/4a93e4e8cbe1b7a23a8be706291a270ccdf5bb55))
* photo visibility control with client access ([#172](https://github.com/PiR1/picpeak/issues/172)) ([e1b6e43](https://github.com/PiR1/picpeak/commit/e1b6e43e524211c913d3d29ade5fc029df12920f))
* pre-zip download all and photo replacement by name ([#312](https://github.com/PiR1/picpeak/issues/312), [#313](https://github.com/PiR1/picpeak/issues/313)) ([d3f1206](https://github.com/PiR1/picpeak/commit/d3f12068164a6bfe6c4a3817ad2fc2e8ed7abf4f))
* pre-zip download all and photo replacement by name ([#312](https://github.com/PiR1/picpeak/issues/312), [#313](https://github.com/PiR1/picpeak/issues/313)) ([e18afd3](https://github.com/PiR1/picpeak/commit/e18afd3e6b0b5a4cdb4873fb227d1b1d2bf35f21))
* presigned download UI + S3 prefix walker auto-importer (follow-ups) ([446d80a](https://github.com/PiR1/picpeak/commit/446d80a4cc5eb0389994e29585b2a98dad373db2))
* public v1 API + token management + OpenAPI docs ([#322](https://github.com/PiR1/picpeak/issues/322)) ([808b15b](https://github.com/PiR1/picpeak/commit/808b15bafbcdab6ea55aff7f0e507153f513a70a))
* register Russian locale and add to language selector ([6f95b8c](https://github.com/PiR1/picpeak/commit/6f95b8c26cd794525e15e45d478f9ead0ec22555))
* S3 storage + webhooks + settings dedupe + backup fixes ([06d54be](https://github.com/PiR1/picpeak/commit/06d54bec4d0afc4a1b9ba6f2449ed7d79f1d3e8f))
* show original filename in admin UI ([#184](https://github.com/PiR1/picpeak/issues/184)) ([0891be1](https://github.com/PiR1/picpeak/commit/0891be197fdb7d92ade5a293b8db0bed26fa6e3a))
* sort photos by capture date with configurable default sort ([#283](https://github.com/PiR1/picpeak/issues/283)) ([8805fa5](https://github.com/PiR1/picpeak/commit/8805fa53e61c6b3672a8f6dad14d2fd17998a451))
* sort photos by capture date with configurable default sort ([#283](https://github.com/PiR1/picpeak/issues/283)) ([633d4a0](https://github.com/PiR1/picpeak/commit/633d4a0f301e355ee9f057347f2f8dee8c5b4163))
* support Apple Silicon natively via multi-arch images ([c282a72](https://github.com/PiR1/picpeak/commit/c282a72bd35db062cec25770a42cf9c803388e44))
* **theme:** expand color settings to 8-token CI palette + alt button ([114aab5](https://github.com/PiR1/picpeak/commit/114aab57771a4bba03a9e5c616c75a37c9b25969))
* **translations:** add French language support and improve localization handling ([a5db4bd](https://github.com/PiR1/picpeak/commit/a5db4bd46e6a5cc84c9563588f90d3461c277528))
* **upload:** async photo processing — backend (PR-B part 1) ([851744c](https://github.com/PiR1/picpeak/commit/851744c3c4df7deba8d946b6592fdb5042c52a26))
* **upload:** async photo processing — frontend (PR-B part 2) ([3b827b8](https://github.com/PiR1/picpeak/commit/3b827b80d51269e1a7b9c693396f3cb7a9a48ffc))
* **upload:** async photo processing + fix(auth): /auth/session symmetry (loop fix) ([907bcf1](https://github.com/PiR1/picpeak/commit/907bcf1eb2d44ded149a1caf39ee1cfe63fec994))
* **upload:** two-state UI + temp dir cleanup (PR-A of async processing) ([86dfcc4](https://github.com/PiR1/picpeak/commit/86dfcc4f116a394e7e092ab3e01f3f1d030bb367))
* visual WYSIWYG email template editor ([703c03f](https://github.com/PiR1/picpeak/commit/703c03fbee754a5291b57b885c5e82fbdd3e69e9))
* warn about low thumbnail resolution when selecting beta themes ([ee3f6ae](https://github.com/PiR1/picpeak/commit/ee3f6ae13bf9c9fb3295286e84150e04bf9fbce4))
* warn about low thumbnail resolution with beta themes ([aef9b4e](https://github.com/PiR1/picpeak/commit/aef9b4ed7fc443cbec8890c580759077e05e77b4))
* **webhooks:** enrich event.* payloads with customer contact + share_token ([#341](https://github.com/PiR1/picpeak/issues/341)) ([7ea4801](https://github.com/PiR1/picpeak/commit/7ea4801544fd5cd8bca1907a71b5c4e96ee77649))
* **webhooks:** enrich event.* payloads with customer contact + share_token ([#341](https://github.com/PiR1/picpeak/issues/341)) ([1e69d5f](https://github.com/PiR1/picpeak/commit/1e69d5ff71ac2d1d133b0e40637b437d7cc8bc4f))


### Bug Fixes

* add allow_user_uploads to gallery API responses ([691e3ab](https://github.com/PiR1/picpeak/commit/691e3aba09f2148afe902a0bb0139d062634e669))
* add STORAGE_PATH to production docker-compose ([cdda709](https://github.com/PiR1/picpeak/commit/cdda70988664a177b351abc6a259ec39664d17ff))
* address beta feedback - gallery layout fixes, Russian locale, email logo ([#249](https://github.com/PiR1/picpeak/issues/249)) ([486239a](https://github.com/PiR1/picpeak/commit/486239aeb9b5f56551d5aa90f0bad3008eedc3bb))
* address bugs and feature requests from discussion [#317](https://github.com/PiR1/picpeak/issues/317) ([6cfff6f](https://github.com/PiR1/picpeak/commit/6cfff6f6a6dbdc5bc1e9fe4fbce5795cdb1855c6))
* address Shannon security assessment findings (37 vulnerabilities) ([#254](https://github.com/PiR1/picpeak/issues/254)) ([23cd9cb](https://github.com/PiR1/picpeak/commit/23cd9cb680eb77b94a97266c3353dfc835f0cc69))
* admin photo feedback filters have no effect ([#293](https://github.com/PiR1/picpeak/issues/293)) ([9ed8a2b](https://github.com/PiR1/picpeak/commit/9ed8a2b1994d139efd100c8fb97e6368655e5530))
* **admin:** tab underlines use accent (not accent-dark) for proper highlight color ([565ae45](https://github.com/PiR1/picpeak/commit/565ae45ca71e46166c8bbfc0eb0b6da92d74f120))
* **admin:** test email always sends, regardless of update availability ([#418](https://github.com/PiR1/picpeak/issues/418)) ([9326a42](https://github.com/PiR1/picpeak/commit/9326a427b32458dfdaa01530bac66cda84ed7b72))
* **admin:** test email always sends, regardless of update availability ([#418](https://github.com/PiR1/picpeak/issues/418)) ([c2b1854](https://github.com/PiR1/picpeak/commit/c2b1854df631354a977d737e8a00ddbc6fa8889f))
* apply password change fix to regular modal + longer toast delay ([#263](https://github.com/PiR1/picpeak/issues/263)) ([c63bc47](https://github.com/PiR1/picpeak/commit/c63bc47089b4b32c570bdeeb1f82bf722569875f))
* apply password change redirect fix to regular modal too ([#263](https://github.com/PiR1/picpeak/issues/263)) ([147dc28](https://github.com/PiR1/picpeak/commit/147dc28440ca69ed970677fa221dfac00c8e2560))
* apply sort direction in gallery and respect show_feedback_to_guests ([#302](https://github.com/PiR1/picpeak/issues/302), [#303](https://github.com/PiR1/picpeak/issues/303)) ([3716ff5](https://github.com/PiR1/picpeak/commit/3716ff50854766bde588fbd6b9027f8647e59150))
* apply sort direction in gallery view and respect show_feedback_to_guests ([#302](https://github.com/PiR1/picpeak/issues/302), [#303](https://github.com/PiR1/picpeak/issues/303)) ([dffe057](https://github.com/PiR1/picpeak/commit/dffe057772c922ab6a213e25f171157e0c2badf8))
* **auth:** /auth/session must enforce session timeout symmetrically ([#350](https://github.com/PiR1/picpeak/issues/350) recurrence) ([c8e09c2](https://github.com/PiR1/picpeak/commit/c8e09c2a2a7d0920901560317eecd773b83251c0))
* **auth:** /auth/session must enforce session timeout symmetrically ([#350](https://github.com/PiR1/picpeak/issues/350) recurrence) ([b106da1](https://github.com/PiR1/picpeak/commit/b106da1ededa27fc8727f2c0e74a9182e6e9c895))
* **auth:** /auth/session must reject tokens that adminAuth/galleryAuth would reject ([f905f7e](https://github.com/PiR1/picpeak/commit/f905f7e7336c756e73a8c650c9239b171697164a))
* **auth:** /auth/session must verify issuer claim like adminAuth ([#350](https://github.com/PiR1/picpeak/issues/350)) ([83dedbc](https://github.com/PiR1/picpeak/commit/83dedbcd45e34a924594dd83f6e3561f776576fb))
* **auth:** default COOKIE_SECURE to 'auto' in production + first-install UX ([#427](https://github.com/PiR1/picpeak/issues/427)) ([e1c9382](https://github.com/PiR1/picpeak/commit/e1c93823c4a3095dd2afa618f393a061806f18a3))
* **auth:** default COOKIE_SECURE to 'auto' in production + first-install UX ([#427](https://github.com/PiR1/picpeak/issues/427)) ([5c7de96](https://github.com/PiR1/picpeak/commit/5c7de96b7fda9ca037a01b93fabe69d1be224893))
* **auth:** make /auth/session verify the issuer claim like adminAuth ([#350](https://github.com/PiR1/picpeak/issues/350)) ([88a6c6a](https://github.com/PiR1/picpeak/commit/88a6c6a7fba7e1419a021f4870518f0b76ac6494))
* **backup:** cron schedule mapping + manifest format detection + bigint coerce ([ab4095f](https://github.com/PiR1/picpeak/commit/ab4095f5928b1476009cddfd3444d6f5b58b034d))
* **backup:** incremental backups against S3 + jsonb stats parsing ([e232f9f](https://github.com/PiR1/picpeak/commit/e232f9f2cf54aeba1e16d769397428206a0f1801))
* **branding:** admin sidebar uses accent-dark, primary buttons follow CI token ([fc2bce3](https://github.com/PiR1/picpeak/commit/fc2bce3a01f02b2d131ca4ce1c8e81fc9dc62755))
* **branding:** comprehensive sweep — replace remaining primary-* legacy colors with accent tokens ([578a174](https://github.com/PiR1/picpeak/commit/578a1745b8d010eeeb261d3452fd192b1ec7bcf8))
* **branding:** selected-state accent colors, force-mode actually flips galleries, compact color picker layout ([5b410ed](https://github.com/PiR1/picpeak/commit/5b410ed9f87daad8e96345a86897f2a9e9419802))
* **branding:** working tooltips, high-contrast selected states, gallery chrome follows accent ([b19bb0c](https://github.com/PiR1/picpeak/commit/b19bb0c6208744f329cb3e99f4e26a83f191710a))
* **cms:** apply dark mode to CMS editor, public CMS, and admin modals ([d2a10f6](https://github.com/PiR1/picpeak/commit/d2a10f6523655488267d6f68835d7adb46dcf962))
* **cms:** nl/pt/ru i18n + gate external_url in public response ([08d0462](https://github.com/PiR1/picpeak/commit/08d046276bf259e8511b01415141f51b8484f967))
* **cms:** nl/pt/ru i18n + gate external_url in public response ([bce5c1f](https://github.com/PiR1/picpeak/commit/bce5c1f725043965c2499515f18e93e9578bd204))
* correct invitation activation validation and add missing translations ([991aa98](https://github.com/PiR1/picpeak/commit/991aa98f98cffd1d7785c272726615325e2c0208)), closes [#129](https://github.com/PiR1/picpeak/issues/129)
* correct invitation email link URL path ([86fa104](https://github.com/PiR1/picpeak/commit/86fa1046d5439cb451feb164175c919c49ca219a)), closes [#129](https://github.com/PiR1/picpeak/issues/129)
* correct storage path resolution in multiple files ([#96](https://github.com/PiR1/picpeak/issues/96)) ([0e3674b](https://github.com/PiR1/picpeak/commit/0e3674b2b0325bbcee5aa2c9ff7781da92f612d1))
* correct storage path resolution in multiple files ([#96](https://github.com/PiR1/picpeak/issues/96)) ([3ccb815](https://github.com/PiR1/picpeak/commit/3ccb8154eb40a432aa467fb06b3f216fd0d2c6b4))
* **create-event:** re-apply Branding theme on stale→fresh settings ([#323](https://github.com/PiR1/picpeak/issues/323)-B) ([401abf7](https://github.com/PiR1/picpeak/commit/401abf7a27cb73dd7fb8399f4c05644c95767093))
* dedupe parallel admin 401 redirects to /admin/login ([038e84c](https://github.com/PiR1/picpeak/commit/038e84cae7f56a0a1af8c71b85881ca5d320c6e3))
* discussion [#317](https://github.com/PiR1/picpeak/issues/317) issues and [#318](https://github.com/PiR1/picpeak/issues/318) archive crash ([2f2f405](https://github.com/PiR1/picpeak/commit/2f2f405d9bc2831b3bbe2ca7fbf726d61382dc38))
* display welcome message in gallery and fix guest thumbnail URLs ([#306](https://github.com/PiR1/picpeak/issues/306), [#307](https://github.com/PiR1/picpeak/issues/307)) ([b05c36a](https://github.com/PiR1/picpeak/commit/b05c36ac810a557a2ac088ab7bec39bb76f9a2ae))
* display welcome message in gallery and fix guest thumbnail URLs ([#306](https://github.com/PiR1/picpeak/issues/306), [#307](https://github.com/PiR1/picpeak/issues/307)) ([9323bef](https://github.com/PiR1/picpeak/commit/9323befdd99d64b85cca89af24ac1b7034d72eee))
* docker compose v2 syntax and add missing ADMIN_PASSWORD to .env.example ([#189](https://github.com/PiR1/picpeak/issues/189)) ([0817443](https://github.com/PiR1/picpeak/commit/0817443e793e37c770c6a1968ecae4b9464107b0))
* **docker:** install system ffmpeg on Alpine, drop broken bundled binary ([3ab8a64](https://github.com/PiR1/picpeak/commit/3ab8a64a24f1600e674f77d39139e33857b4dfc8))
* **docker:** install system ffmpeg on Alpine, drop broken bundled binary ([96818c7](https://github.com/PiR1/picpeak/commit/96818c7ae8de0d8fd478cd901ea25a3272eee85d))
* **email:** render conditionals, localise password placeholders, fix caller/template variable drift ([0767203](https://github.com/PiR1/picpeak/commit/07672038d4ac31fc601adfb2338104223856ba71))
* **email:** render conditionals, localise password placeholders, fix caller/template variable drift ([e8052ad](https://github.com/PiR1/picpeak/commit/e8052adf1d2f1717652ac5d6b8cd8bcc01787189))
* event-specific custom CSS settings not being saved ([dadef81](https://github.com/PiR1/picpeak/commit/dadef81158972d28aa32812203500f77ed08a999)), closes [#136](https://github.com/PiR1/picpeak/issues/136)
* **event:** correct updating client access ([d00f6fa](https://github.com/PiR1/picpeak/commit/d00f6fa7de59bdbd30efe9ce824e795cf05616f4))
* **event:** ensure client share token is generated only when necessary ([916580a](https://github.com/PiR1/picpeak/commit/916580adefd464417729e418aa1727b67566fea3))
* events search/counters ([#346](https://github.com/PiR1/picpeak/issues/346)), lazy gallery skeleton ([#321](https://github.com/PiR1/picpeak/issues/321)), smooth lightbox swipe ([#348](https://github.com/PiR1/picpeak/issues/348)) ([6229b38](https://github.com/PiR1/picpeak/commit/6229b38bac90cc0c538a72688efae3be77a3bb08))
* events without expiration date incorrectly shown as expired ([c4f16eb](https://github.com/PiR1/picpeak/commit/c4f16eb76c909158abdb63aa4cc22f817f274dc5))
* **events:** admin-set password on reset, full-URL gallery_link in all emails ([0d1f82d](https://github.com/PiR1/picpeak/commit/0d1f82d31a2f9e30bf193496ac203eaf8dfd856b))
* **events:** admin-set password on reset, full-URL gallery_link in all emails ([ff50c74](https://github.com/PiR1/picpeak/commit/ff50c74e1912ccba60f7ccdbead92b76de91388b))
* **events:** coerce expires_in_days to Number before addDays ([e5712d8](https://github.com/PiR1/picpeak/commit/e5712d8ffe2f0ed980e1df5e1263876af7202b76))
* **events:** coerce expires_in_days to Number before addDays ([db29d0e](https://github.com/PiR1/picpeak/commit/db29d0e2788f63cc9eb0a43ec58313387acb0c0d))
* **events:** match scrollbar to theme in external folder tree picker ([bd42ee1](https://github.com/PiR1/picpeak/commit/bd42ee1ce03b8f6e7b011b53f2c71453be931cc6))
* **events:** server-side search/pagination to remove first-100 cap ([#346](https://github.com/PiR1/picpeak/issues/346)) ([a5b20ca](https://github.com/PiR1/picpeak/commit/a5b20ca3fe77df665d4a9744413d7ee4054858f0))
* **events:** show customer phone in event details view ([#331](https://github.com/PiR1/picpeak/issues/331)) ([4c73d22](https://github.com/PiR1/picpeak/commit/4c73d228ed98b8ec05bec2824aee7ce066a184e1))
* **events:** stop mapping branding_logo_position onto hero_logo_position ([af2b062](https://github.com/PiR1/picpeak/commit/af2b0628cb4f79a147366665d35c098012071216))
* **events:** stop mapping branding_logo_position onto hero_logo_position ([ef1c875](https://github.com/PiR1/picpeak/commit/ef1c875f6ec1e02657006cb09cd0b1d868ec2fc0))
* **events:** typed-DELETE confirmation for bulk delete ([#417](https://github.com/PiR1/picpeak/issues/417)) ([e165ee5](https://github.com/PiR1/picpeak/commit/e165ee5d9fa805c704a64f91c9514bf0ab75b5b8))
* **events:** typed-DELETE confirmation for bulk delete ([#417](https://github.com/PiR1/picpeak/issues/417)) ([99e420b](https://github.com/PiR1/picpeak/commit/99e420b1b9783a1d6b4eb892c09d0af3340bf314))
* external media dimensions, theme race condition, email color customization ([dfae2c2](https://github.com/PiR1/picpeak/commit/dfae2c2bc6d86378c553cd847b439f7cb53a4f2a))
* **external-media:** pre-generate thumbnails so reference-mode galleries load fast ([#423](https://github.com/PiR1/picpeak/issues/423)) ([e2ffd9f](https://github.com/PiR1/picpeak/commit/e2ffd9f93d228f9e16408fe424c65b26db67ac8e))
* **external-media:** pre-generate thumbnails so reference-mode galleries load fast ([#423](https://github.com/PiR1/picpeak/issues/423)) ([f3d0f16](https://github.com/PiR1/picpeak/commit/f3d0f161c9e554a5149e6b4eafdb0ac42bebf277))
* floor password_changed_at when comparing against JWT iat ([793e410](https://github.com/PiR1/picpeak/commit/793e410554b461522fbe24014dfd3baa915da2bb))
* **fonts:** drop immutable Cache-Control to allow font replacement rollout ([5703fcb](https://github.com/PiR1/picpeak/commit/5703fcb80680155e3b637dd5fc15c430de963c40))
* **gallery:** default controls to inline for every layout ([045e9ea](https://github.com/PiR1/picpeak/commit/045e9ea4861f33e3e82e31f978ac297c7f7824f6))
* **gallery:** lazy-render skeleton grid for fast loads ([#321](https://github.com/PiR1/picpeak/issues/321) follow-up) ([d9d8137](https://github.com/PiR1/picpeak/commit/d9d81372b80f7d44dca54b7993f52c36574048c9))
* **gallery:** preserve sidebar controlsStyle on banner migration ([05dadff](https://github.com/PiR1/picpeak/commit/05dadff4934ad9b055de8875846c2a7175e16f86))
* **gallery:** serve thumbnails / photos / hero via storage abstraction ([#432](https://github.com/PiR1/picpeak/issues/432)) ([d3007b0](https://github.com/PiR1/picpeak/commit/d3007b0dd29d37a46ce26e8b4eb15908e0f8e3d2))
* **gallery:** serve thumbnails / photos / hero via storage abstraction ([#432](https://github.com/PiR1/picpeak/issues/432)) ([83d79f4](https://github.com/PiR1/picpeak/commit/83d79f4d39f2a68c8cb905cbd1b46d53bba80f49))
* **gallery:** single-finger swipe nav in mobile lightbox ([#332](https://github.com/PiR1/picpeak/issues/332)) ([4c8eba0](https://github.com/PiR1/picpeak/commit/4c8eba0cb43635d92a53d90c58b19007136c1c12))
* **gallery:** use ref for swipe-start to avoid stale-closure miss ([#332](https://github.com/PiR1/picpeak/issues/332)) ([fcddfe0](https://github.com/PiR1/picpeak/commit/fcddfe094b2a01963f7b420afa886e7d5dae4390))
* **gallery:** WCAG-safe Download button text + extract HeaderDownloadButton ([#401](https://github.com/PiR1/picpeak/issues/401) follow-ups) ([04e928d](https://github.com/PiR1/picpeak/commit/04e928d7621743d9d99797f0996f8c7aa50e7b2d))
* **gallery:** WCAG-safe Download button text + extract HeaderDownloadButton ([#401](https://github.com/PiR1/picpeak/issues/401) follow-ups) ([0c80abd](https://github.com/PiR1/picpeak/commit/0c80abd57b806b9df01429a093c30c12c80c0601))
* guest feedback flow bugs in Masonry grid and PhotoLightbox ([#292](https://github.com/PiR1/picpeak/issues/292)) ([54badef](https://github.com/PiR1/picpeak/commit/54badefc51b834d55530722f87c81a6ade33e35b))
* guest feedback flow bugs in Masonry grid and PhotoLightbox ([#292](https://github.com/PiR1/picpeak/issues/292)) ([77f07e9](https://github.com/PiR1/picpeak/commit/77f07e9329e47f6ac5040f2e85d2710ebbea3ced))
* handle null dates in dashboard and gallery pages ([c5a8ffc](https://github.com/PiR1/picpeak/commit/c5a8ffc08cd4c53c37fe4fb9cde8519a68f1f343))
* hero header state and preview in admin theme editor ([#158](https://github.com/PiR1/picpeak/issues/158)) ([f554f46](https://github.com/PiR1/picpeak/commit/f554f463b3492346dba067c0980b52ef42dd5e70))
* improve ghost button visibility in admin dark mode ([4912e2b](https://github.com/PiR1/picpeak/commit/4912e2bccf282134d5598a8ac80942ed46d0523c))
* improve password validation errors and event list UX ([#170](https://github.com/PiR1/picpeak/issues/170), [#171](https://github.com/PiR1/picpeak/issues/171)) ([171abb3](https://github.com/PiR1/picpeak/commit/171abb31615484d77cf95a99cb5634afa0160adc))
* improve photo serving, category filters, and upload chunking ([#155](https://github.com/PiR1/picpeak/issues/155), [#156](https://github.com/PiR1/picpeak/issues/156), [#161](https://github.com/PiR1/picpeak/issues/161)) ([fa4c838](https://github.com/PiR1/picpeak/commit/fa4c83812d87cfa63394e51186e320a072929d37))
* increase upload limit to 1GB and fix category filters ([#155](https://github.com/PiR1/picpeak/issues/155), [#156](https://github.com/PiR1/picpeak/issues/156)) ([397d33a](https://github.com/PiR1/picpeak/commit/397d33a95a09e0b0986c3f6cf5965c544992a764))
* issue [#203](https://github.com/PiR1/picpeak/issues/203) file type validation + security CVE fixes ([8017171](https://github.com/PiR1/picpeak/commit/80171713e0ffedda56f7cffb403b25a8d55634d1))
* **lightbox:** mobile toolbar clipping + iOS safe-area + viewport-fit ([#336](https://github.com/PiR1/picpeak/issues/336)) ([42a7ae4](https://github.com/PiR1/picpeak/commit/42a7ae4be8fe7b12104ae036465c9c4117606378))
* **lightbox:** smooth carousel swipe + drop instructional hint ([#348](https://github.com/PiR1/picpeak/issues/348)) ([743086d](https://github.com/PiR1/picpeak/commit/743086d3cb9100fb163bc9d04d968e5b611a1f99))
* mobile lightbox + share previews + customer phone bug triage ([1e40677](https://github.com/PiR1/picpeak/commit/1e4067713ce9a808a7b49319bc262e5c9a6599c6))
* mobile upload button not visible in gallery ([#113](https://github.com/PiR1/picpeak/issues/113)) ([cacaffa](https://github.com/PiR1/picpeak/commit/cacaffa5c39f67105c4cfb092ea62157121fb72e))
* **nginx:** proxy /fonts requests to backend ([e6c03e4](https://github.com/PiR1/picpeak/commit/e6c03e4b6e4ee2ccc3e3cd8b7a54c18f9685c2ba))
* pin npm to v10 in backend Dockerfile ([ddefd3a](https://github.com/PiR1/picpeak/commit/ddefd3a95e5047d4a22aa4b6fef57dfb1c880967))
* pin npm upgrade to v10 in backend Dockerfile ([978e447](https://github.com/PiR1/picpeak/commit/978e4473b5227ee61ad7d17487063eb3284bea36))
* prevent backend crash on archive when admin_email is null ([#318](https://github.com/PiR1/picpeak/issues/318)) ([e4b0f96](https://github.com/PiR1/picpeak/commit/e4b0f961b75952b6907cc2291fa256215c09c80c))
* remove non-functional watermark toggle from Feature Toggles ([d4a15db](https://github.com/PiR1/picpeak/commit/d4a15dbe74d0d70bbe6ff03362dc7337fb8f4c5c))
* render minimal/none header styles, cap hero height, switch category hero images ([#158](https://github.com/PiR1/picpeak/issues/158), [#162](https://github.com/PiR1/picpeak/issues/162), [#163](https://github.com/PiR1/picpeak/issues/163)) ([bc6c48b](https://github.com/PiR1/picpeak/commit/bc6c48bb2429505c2de3641693a8ff4f623a4951))
* resend gallery email fails for events without password ([6b3ead7](https://github.com/PiR1/picpeak/commit/6b3ead747b1395d8ea2b3d135a5ac24db05e2eb8)), closes [#137](https://github.com/PiR1/picpeak/issues/137)
* resolve admin invitation flow issues and improve STORAGE_PATH documentation ([41bf6ff](https://github.com/PiR1/picpeak/commit/41bf6ff884d5ef3181f95f3aa4a528434c23947a))
* resolve code quality issues and add missing i18n keys ([#162](https://github.com/PiR1/picpeak/issues/162), [#163](https://github.com/PiR1/picpeak/issues/163)) ([329d224](https://github.com/PiR1/picpeak/commit/329d224846d3f4eefa31e42337f34047c267d578))
* resolve code scanning security alerts (multer, tar, Node 22) ([85a07fc](https://github.com/PiR1/picpeak/commit/85a07fcca7ad935f4c0c300f5ffe2f3af8da1e5f))
* resolve external media dimensions, gallery theme race condition, and add email color customization ([bbeedd1](https://github.com/PiR1/picpeak/commit/bbeedd1888561b6c57586b5f42bbfee3ffc69fd7))
* resolve issues [#194](https://github.com/PiR1/picpeak/issues/194), [#195](https://github.com/PiR1/picpeak/issues/195), [#196](https://github.com/PiR1/picpeak/issues/196), [#197](https://github.com/PiR1/picpeak/issues/197) ([33af088](https://github.com/PiR1/picpeak/commit/33af0885607799e0071e2e74a582c7eb396c9b83))
* resolve issues [#194](https://github.com/PiR1/picpeak/issues/194), [#195](https://github.com/PiR1/picpeak/issues/195), [#196](https://github.com/PiR1/picpeak/issues/196), [#197](https://github.com/PiR1/picpeak/issues/197) ([5ea4ef3](https://github.com/PiR1/picpeak/commit/5ea4ef3cf36b06f9e6c9108f80bfe2e9a6470898))
* resolve issues [#194](https://github.com/PiR1/picpeak/issues/194), [#195](https://github.com/PiR1/picpeak/issues/195), [#196](https://github.com/PiR1/picpeak/issues/196), [#197](https://github.com/PiR1/picpeak/issues/197) ([33483cf](https://github.com/PiR1/picpeak/commit/33483cf32dfae57f8da51c0765353792239135f9))
* resolve issues [#194](https://github.com/PiR1/picpeak/issues/194), [#195](https://github.com/PiR1/picpeak/issues/195), [#196](https://github.com/PiR1/picpeak/issues/196), [#197](https://github.com/PiR1/picpeak/issues/197) ([cd00bc1](https://github.com/PiR1/picpeak/commit/cd00bc13d4e02a86a0f1742ed1f11f064614b8da))
* resolve JWT iat timing issue in password change ([#263](https://github.com/PiR1/picpeak/issues/263)) ([c031b1e](https://github.com/PiR1/picpeak/commit/c031b1e86333d90e8e0e0aa723572efa110f7fd1))
* resolve mixed light/dark mode styling in admin UI ([#175](https://github.com/PiR1/picpeak/issues/175)) ([f8c8abd](https://github.com/PiR1/picpeak/commit/f8c8abd70bbae35d6cd519894624ade33b5115a8))
* resolve password change redirect loop ([#263](https://github.com/PiR1/picpeak/issues/263)) and file watcher crash ([#269](https://github.com/PiR1/picpeak/issues/269)) ([b23c51b](https://github.com/PiR1/picpeak/commit/b23c51b386270dee4d911902b728dfacb1ff1bf9))
* resolve password change redirect loop and file watcher crash ([835bdf5](https://github.com/PiR1/picpeak/commit/835bdf5abb40c7b143c5cdafb507c317a7c349bf)), closes [#269](https://github.com/PiR1/picpeak/issues/269)
* resolve redirect loop after mandatory password change ([#263](https://github.com/PiR1/picpeak/issues/263)) ([07fc5e6](https://github.com/PiR1/picpeak/commit/07fc5e6519cd84f2214479d5f31bc35a495bfe4b))
* resolve redirect loop after mandatory password change ([#263](https://github.com/PiR1/picpeak/issues/263)) ([3c8d344](https://github.com/PiR1/picpeak/commit/3c8d344ddd23974c9cf0f5f63edd6cd07817fee9))
* respect allowed_file_types setting for upload validation ([#203](https://github.com/PiR1/picpeak/issues/203)) ([fe07a14](https://github.com/PiR1/picpeak/commit/fe07a148f1d998c0be00377c1f8b4eca3908305c))
* respect optional email settings in event creation ([831ea6a](https://github.com/PiR1/picpeak/commit/831ea6a3bccfae4ec00ce1f619967b91b85150ce))
* respect optional email settings in event creation ([#217](https://github.com/PiR1/picpeak/issues/217)) ([9c44a0e](https://github.com/PiR1/picpeak/commit/9c44a0ebfa527fa133512eb7f2f03335a2377aaa))
* restore aspect-ratio layouts and improve hero image quality ([#180](https://github.com/PiR1/picpeak/issues/180)) ([3974ba5](https://github.com/PiR1/picpeak/commit/3974ba5de5a6605ad906608d3e4d61620a215059))
* restore aspect-ratio layouts and improve hero image quality ([#180](https://github.com/PiR1/picpeak/issues/180)) ([5cef7fd](https://github.com/PiR1/picpeak/commit/5cef7fdd188389512bc4b55ae61536c8b1219eb8))
* revert /api prefix in adminPhotos.js to avoid double-prefix ([094276d](https://github.com/PiR1/picpeak/commit/094276d3cc7117eee30e4bcbce487e54f0eacb29))
* revert /api prefix in adminPhotos.js to avoid double-prefix ([#307](https://github.com/PiR1/picpeak/issues/307)) ([ceb2a09](https://github.com/PiR1/picpeak/commit/ceb2a09f483b4754fda232c5c1f7acb8971aac10))
* **security:** invalidate tokens on password change, enforce session timeout, fix role update ([f362239](https://github.com/PiR1/picpeak/commit/f3622396e77ce5d0b0741e439fc554a1dccaca50))
* **security:** patch 18 dependency CVEs (axios + transitives + nodemailer + i18next-http-backend) ([b7d6ca0](https://github.com/PiR1/picpeak/commit/b7d6ca0b65e652b50d957380f93ed16e151e94a8))
* **security:** patch 18 dependency CVEs (axios + transitives) ([523f499](https://github.com/PiR1/picpeak/commit/523f49916bea44697d40f61e0b6e44b83decc4b9))
* **security:** resolve all npm audit vulnerabilities ([4272618](https://github.com/PiR1/picpeak/commit/4272618b3f7fcb06aaca14fb724a6a7733251f24))
* **security:** resolve Docker image CVEs for code scanning alerts ([cbecb93](https://github.com/PiR1/picpeak/commit/cbecb9323cf4b80c800326de14f6df73f60147c1))
* **security:** scan triage cleanup — drop dead deps, harden Docker/nginx/postMessage ([7abfeb9](https://github.com/PiR1/picpeak/commit/7abfeb91cc7bbb9b6853146dbfe16b8d9835bcb3))
* **security:** scan triage cleanup — drop dead deps, harden Docker/nginx/postMessage ([6b6191a](https://github.com/PiR1/picpeak/commit/6b6191a4260650e21c45f6153cac1b142bf8483a))
* **security:** token invalidation on password change, session timeout enforcement ([7ca9631](https://github.com/PiR1/picpeak/commit/7ca96315e254eef58d8ecc505f95a5186d2fa2da))
* set JWT iat after password_changed_at to prevent token rejection ([#263](https://github.com/PiR1/picpeak/issues/263)) ([b1d1667](https://github.com/PiR1/picpeak/commit/b1d16670d56e19f7b35e7f2f12f3611fdb3fab58))
* **share:** OG/Twitter-card metadata for gallery share URLs ([#333](https://github.com/PiR1/picpeak/issues/333)) ([5275621](https://github.com/PiR1/picpeak/commit/5275621fcd38f1ec09b54595163ecd5e63614b1a))
* shorten Save button label on email template editor ([7250c42](https://github.com/PiR1/picpeak/commit/7250c427b905ffa3e8696dff607450f5a0b801b8))
* sync header_style DB column with theme editor selections ([#158](https://github.com/PiR1/picpeak/issues/158)) ([2288309](https://github.com/PiR1/picpeak/commit/228830939553fd32c250704bb89a8ce233324d25))
* sync header_style DB column with theme editor selections ([#158](https://github.com/PiR1/picpeak/issues/158)) ([a19e7c4](https://github.com/PiR1/picpeak/commit/a19e7c40a200ff822c947a83349ed07ccf4e1b01))
* theme picker buttons no longer submit the parent form ([#326](https://github.com/PiR1/picpeak/issues/326)) ([2eead52](https://github.com/PiR1/picpeak/commit/2eead523193ccb7f23eb767097ad9698e8312833))
* theme save without Live Preview, Branding default on new events, gallery loading flicker ([#323](https://github.com/PiR1/picpeak/issues/323), [#321](https://github.com/PiR1/picpeak/issues/321)) ([822be9a](https://github.com/PiR1/picpeak/commit/822be9a9b2716f1832a4cb6fccd53602e3cbab51))
* theme-preset match loop ignores extra fields like logoUrl ([#323](https://github.com/PiR1/picpeak/issues/323)) ([b63a877](https://github.com/PiR1/picpeak/commit/b63a8774c4b44733b903736b2ca5a472a884055e))
* **theme:** centralise force-mode enforcement inside ThemeContext so every gallery flips ([21188f4](https://github.com/PiR1/picpeak/commit/21188f48d76dd29bc1251bcc6faf9d6d96c805b5))
* **theme:** kill initial white frame + theme-aware skeleton tiles ([#358](https://github.com/PiR1/picpeak/issues/358) follow-up) ([f529c9e](https://github.com/PiR1/picpeak/commit/f529c9e3d72f0e3496951dfa5d160afda9a1ac51))
* **theme:** kill initial white frame + theme-aware skeleton tiles ([#358](https://github.com/PiR1/picpeak/issues/358) follow-up) ([1a530ae](https://github.com/PiR1/picpeak/commit/1a530aeaa2d61b34d9721a555b71631c7101c58e))
* **theme:** pre-React bootstrap to kill white-flash on dark galleries ([#358](https://github.com/PiR1/picpeak/issues/358)) ([07b41e6](https://github.com/PiR1/picpeak/commit/07b41e691d2e8a71f775c667d805a2f9adc10590))
* **theme:** pre-React bootstrap to kill white-flash on dark galleries ([#358](https://github.com/PiR1/picpeak/issues/358)) ([f81a872](https://github.com/PiR1/picpeak/commit/f81a8728e67b313ac43f55c94fb635abf9beca05))
* update dependencies to resolve code scanning security alerts ([1f524f2](https://github.com/PiR1/picpeak/commit/1f524f23580d2e2a21dbba28cb46aed76e85c475))
* update docker-compose to docker compose and add ADMIN_PASSWORD to .env.example ([#189](https://github.com/PiR1/picpeak/issues/189)) ([a4c6248](https://github.com/PiR1/picpeak/commit/a4c624802b2926a16adcf0472a3041562f9b2f48))
* update packages to fix security vulnerabilities ([8097a0c](https://github.com/PiR1/picpeak/commit/8097a0cb530bd8003597cde81606231efadb0bf5))
* update security policy with private reporting channels ([308e086](https://github.com/PiR1/picpeak/commit/308e08626383bab213ce3eb5563608dff6168ef4))
* update security policy with private reporting channels ([7f77362](https://github.com/PiR1/picpeak/commit/7f7736282f534adf4b9d5331d841a1f0bff7341c))
* update security policy with proper contact email and private reporting ([67b0f32](https://github.com/PiR1/picpeak/commit/67b0f32456d0216e4c685a104c680fa5a5fd578f)), closes [#223](https://github.com/PiR1/picpeak/issues/223)
* use actual photo aspect ratios in masonry columns mode ([#146](https://github.com/PiR1/picpeak/issues/146)) ([8711f96](https://github.com/PiR1/picpeak/commit/8711f967a15f5d57f6ad01bfdbd8d33f9ee96abc))
* use CSS Columns for gap-free mosaic layout ([#146](https://github.com/PiR1/picpeak/issues/146)) ([821d329](https://github.com/PiR1/picpeak/commit/821d3296ea4b6bde499e5497d258f15ab8dd1dbc))
* use photo dimensions for mosaic aspect ratios ([#146](https://github.com/PiR1/picpeak/issues/146)) ([27ff51e](https://github.com/PiR1/picpeak/commit/27ff51e7a1217848859b47940bc88caa6f1fb20f))
* video upload media type, select all, and dimension repair ([#203](https://github.com/PiR1/picpeak/issues/203), [#220](https://github.com/PiR1/picpeak/issues/220), [#180](https://github.com/PiR1/picpeak/issues/180)) ([fc75bcd](https://github.com/PiR1/picpeak/commit/fc75bcdfc38673d6e4dd1cd943cfb4638d3a306c))
* video upload, select all, and dimension repair ([#203](https://github.com/PiR1/picpeak/issues/203), [#220](https://github.com/PiR1/picpeak/issues/220), [#180](https://github.com/PiR1/picpeak/issues/180)) ([a0bb080](https://github.com/PiR1/picpeak/commit/a0bb0805868e742f323b64312c3c5ef8ec408f68))
* wire admin photo feedback filters into grid query ([#293](https://github.com/PiR1/picpeak/issues/293)) ([d4b4dc6](https://github.com/PiR1/picpeak/commit/d4b4dc628f28a303ff1c80ba6d8e5e768217ba51))
* wrap email preview with full styled header/footer template ([9a6d2e8](https://github.com/PiR1/picpeak/commit/9a6d2e8e3a3fab8d7969a8a42e94934c38d88392))
* wrap email preview with full styled header/footer template ([fc0911a](https://github.com/PiR1/picpeak/commit/fc0911acf8b7c8a18d71bb4267f1086acd1e0ca1)), closes [#229](https://github.com/PiR1/picpeak/issues/229)
* wrap test email with standard email template ([#252](https://github.com/PiR1/picpeak/issues/252)) ([954a011](https://github.com/PiR1/picpeak/commit/954a0118bae5770c74f1e811e03b8fc702c70db2))


### Reverts

* **branding:** per-option font preview (defer to follow-up) ([f410207](https://github.com/PiR1/picpeak/commit/f410207b2d7ddf1c9525603c7dcbb7cdfee1729b))


### Documentation

* add Buy Me a Coffee badge + Support section ([46bc894](https://github.com/PiR1/picpeak/commit/46bc894d917bd55dbd9bafaa64fd38db21488b81))
* clarify file system photo import requires existing event ([#269](https://github.com/PiR1/picpeak/issues/269)) ([5295516](https://github.com/PiR1/picpeak/commit/5295516b67a1d9f035564c5f9a724f25f8d21c78))
* clarify file system photo import requires existing event ([#269](https://github.com/PiR1/picpeak/issues/269)) ([ee0baaf](https://github.com/PiR1/picpeak/commit/ee0baafc59f3588a26172aa8835c12dcaec35d10))
* **contributing:** update branch reference from main to beta ([ed37caf](https://github.com/PiR1/picpeak/commit/ed37caf3d898d9b2db985e6c6ff203457fd4aa38))
* **contributing:** update branch reference from main to beta ([c114749](https://github.com/PiR1/picpeak/commit/c1147499212ef64e9d8ded89c38d84ab0adc5346))
* emphasize importance of STORAGE_PATH in env example ([3397807](https://github.com/PiR1/picpeak/commit/3397807670784e02cbe34a7a60db43c95d64f19c))
* **fonts:** cache rollout, stale-list note, meta.json ([bd0e052](https://github.com/PiR1/picpeak/commit/bd0e052b1a1847718151a16117dacc6c42a2178e))
* **localization:** enhance French language support and improve i18next configuration ([d1bc5e0](https://github.com/PiR1/picpeak/commit/d1bc5e030f55c15bf09f37b97f8e1608578a2395))
* move documentation to docs.picpeak.app, drop in-repo copies ([02ed5d4](https://github.com/PiR1/picpeak/commit/02ed5d400736f966283a138dedde2455448067ff))
* move documentation to docs.picpeak.app, drop in-repo copies ([0faf9b3](https://github.com/PiR1/picpeak/commit/0faf9b32816f5f94aa584d2336cdb1e0b7082239))
* **readme:** add Contributors section with @Luca-Timo and @Rekoo-PS ([c60ab74](https://github.com/PiR1/picpeak/commit/c60ab74ae2daabc4b11fea1f1b2df728294b03c8))
* **readme:** add Contributors section with @Luca-Timo and @Rekoo-PS ([dbe0a30](https://github.com/PiR1/picpeak/commit/dbe0a3055bd2c71981cb7d9cf43c2b22b9e3276c))
